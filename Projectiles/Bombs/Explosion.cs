...
public class Explosion : ModProjectile // Default explosion, you can use this as a base to create different kinds of explosives (which is what i'm using it for aswell).
{
