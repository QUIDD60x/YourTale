...
# CURRENTLY UPDATED TO 1.4 BUT THERE ARE STILL ISSUES, I have no idea what i'm doing and until there is an official release the code may not work.
Some features have been currently disabled/reworked as a temporary fix, I'm still learning how to use IEntity source and for some reason I just cannot figure it out (so Cryolisis is completely gone ATM and modded NPC drops are wack.)
