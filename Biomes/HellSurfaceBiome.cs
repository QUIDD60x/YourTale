...
public class HellSurfaceBiome : ModBiome
{
	// Select all the scenery
	public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("yourtale/HellWaterStyle"); // Sets a water style for when inside this biome
	public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("yourtale/HellSurfaceBackgroundStyle");
	public override CaptureBiome.TileColorStyle TileColorStyle => CaptureBiome.TileColorStyle.Crimson;

	// Select Music
	public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/Jams");
	...
	public override bool IsBiomeActive(Player player)
	{
		...
		bool b1 = ModContent.GetInstance<BiomeTileCount>().exampleBlockCount >= 40;
