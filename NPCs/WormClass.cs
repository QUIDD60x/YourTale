...
namespace yourtale.NPCs
{
	...
	/// </summary>
	public abstract class WormHead : WormClass
	{
	...
	public abstract class WormBody : WormClass
	{
		...
		internal static void CommonAI_BodyTail(WormClass worm)
		{
	...
	public abstract class WormTail : WormClass
	{
