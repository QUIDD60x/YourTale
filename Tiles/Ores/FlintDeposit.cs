		...
		public class FlintOreSystem : ModSystem
		{
			public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
			{
				...
				if (ShiniesIndex != -1)
				{
					...
					tasks.Insert(ShiniesIndex + 1, new FlintOrePass("Flint", 237.4298f));
				}
			}
		}

		public class FlintOrePass : GenPass
		{
			public FlintOrePass(string name, float loadWeight) : base(name, loadWeight)
			{
			}
			...
			protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
			{
				...
				progress.Message = "Adding in Flint...";
