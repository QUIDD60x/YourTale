...
namespace yourtale.Items.Weapons.Summon
{
	...
	public class FlowerPowerItem : ModItem
	{
		...
		{
			CreateRecipe()
				.AddIngredient(ModContent.ItemType<LifeShard>(), 10)
	...
	public class FlowerMinionProj : ModProjectile
	{
		...
		private bool CheckActive(Player owner)
		{
			...
			{
				owner.ClearBuff(ModContent.BuffType<FlowerSummonBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<FlowerSummonBuff>()))
			{
