...
{
	public class TridentOP : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Tident of Posideon");
		...
		public override void SetDefaults()
		{
			...
			Item.value = Item.sellPrice(gold: 3, silver: 15); // The number and type of coins item can be sold for to an NPC
			...
			Item.shoot = ModContent.ProjectileType<TridentOProj>(); // The projectile that is fired from this weapon
		}
